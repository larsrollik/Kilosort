session_name = '2021-07-09_16-38-27__openfield'
session_name = 'LBR__c344858_m1113182__LR__npx_chrimson_on/LBR__c344858_m1113182__LR__npx_chrimson_on__20210709_150607__task__track_2'
...
rootZ = fullfile(storage_path, session_name, openephys_continuous_dir)
rootY = fullfile(storage_path, session_name)
spikesorting_results = fullfile(rootY, 'spikesorting_ks');
spikesorting_wh = fullfile(rootY, 'spikesorting_wh');
spikesorting_tmp = fullfile(rootY, 'spikesorting_tmp');
